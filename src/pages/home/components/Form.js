...
const FormBlock = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if (Object.keys(newErrors).length > 0) {
            ...
            const formBlock                         = document.querySelector('.contactFormBlock__inner')
    ...
    return(
        <section className="contactFormBlock bottom-space">
            <div className="contactFormBlock__container">
                <div className="contactFormBlock__inner">
                        ...
                        <div className="form__row">
                            ...
                            <div className="form__block">
                                <input
                                    ...
                                    onChange={handleChange}
                                />
                                <label htmlFor="rgpd">Je souhaite être alerté(e) des opportunités immobilières exclusives de Cogedim.</label>
